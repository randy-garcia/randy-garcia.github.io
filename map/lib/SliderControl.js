L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<p style="background-color: #565656;color: #cfe2e5; font-family:Courier new; font-weight: bold;text-align: center;">Slide For Troop Progression</p><div id="leaflet-slider" style="width:200px" style="width:200px><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:10px;background-color:#565656;color: #cfe2e5;font-family:Courier new; font-weight: bold;text-align: center;"></div></div>');
            ...
            slide: function (e, ui) {
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.markers[ui.value].feature !== undefined) {
                        if(_options.markers[ui.value].feature.properties.DAY){
                            if(_options.markers[ui.value]) $('#slider-timestamp').html("June "+_options.markers[ui.value].feature.properties.DAY +" 1944");
                        }else {
                        ...
                        if(_options.markers [ui.value].options.time){
                            if(_options.markers[ui.value]) $('#slider-timestamp').html(_options.markers[ui.value].options.DateStart.substr(0, 19));
                        }else {
                            console.error("You have to have a time property")
                        }
                    }
